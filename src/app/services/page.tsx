    ...
    <main>
                    ...
                    <div className="p-6 sm:p-7 md:p-8 flex-1 flex flex-col">
                      ...
                      <div className="flex flex-wrap gap-1.5 mb-5">
                        {service.benefits.map((b) => (
                          <span
                            key={b}
                            className="inline-flex items-center gap-1 px-2.5 py-1 bg-gray-100 text-text-dark text-xs rounded-full"
                          >
                      ...
                      <a
                        ...
                        className="block text-center bg-gradient-pink text-white py-3 rounded-full text-sm font-semibold hover:-translate-y-0.5 transition-all shadow-[0_4px_15px_rgba(196,120,139,0.3)] hover:shadow-[0_6px_25px_rgba(196,120,139,0.4)] mt-auto"
                      >
                        Book Now
                      </a>
                    </div>
      ...
      <section className="section-pad bg-gray-100">
        <div className="max-w-[800px] mx-auto">
          <AnimatedSection className="text-center mb-10 h-auto">
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-dark section-title-underline">
              Add-On Services
            </h2>
